...
type View = "today" | "floating" | "calendar" | "review" | "reflection" | "tasks" | "rewards" | "settings";
const nav: Array<{ id: View; icon: string }> = [{ id: "today", icon: "☀" }, { id: "floating", icon: "◌" }, { id: "calendar", icon: "▦" }, { id: "review", icon: "≋" }, { id: "reflection", icon: "✎" }, { id: "tasks", icon: "✓" }, { id: "rewards", icon: "✦" }, { id: "settings", icon: "⚙" }];
