...
- A manual `workflow_dispatch` CI run on `main` at this state (`f8bf7e48e39bd9184c98395aa8927d8c3f7bd8ce`, run `36072432474`) failed Core/PR Gate; the sole cause was one stale backup-migration test still asserting the superseded 15-minute-grid Start rule, not a production defect. This closeout PR fixes that test and synchronizes this document and the other macro docs to the state described above.
